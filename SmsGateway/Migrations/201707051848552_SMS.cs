namespace SmsGateway.Migrations
{
    ...
    public partial class SMS : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.BatchMessages", "MessageId", "dbo.Messages");
            DropForeignKey("dbo.BatchMessages", "BatchId", "dbo.Batches");
            ...
            DropIndex("dbo.BatchMessages", new[] { "MessageId" });
            DropIndex("dbo.BatchMessages", new[] { "BatchId" });
